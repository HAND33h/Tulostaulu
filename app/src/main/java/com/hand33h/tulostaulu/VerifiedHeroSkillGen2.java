...
public final class VerifiedHeroSkillGen2 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Philly","Vigor Tactics Attack","ATTACK_UP","ALL_TROOPS","EXPEDITION_PASSIVE",v(3,6,9,12,15),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
        new Row("Philly","Vigor Tactics Defense","DEFENSE_UP","ALL_TROOPS","EXPEDITION_PASSIVE",v(2,4,6,8,10),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
        new Row("Philly","Dosage Boost","ATTACK_DAMAGE","ALL_TROOPS","EXPEDITION_25_PERCENT_CHANCE_ON_ATTACK",v(120,140,160,180,200),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
        new Row("Philly","Energizing Shot","DAMAGE_TAKEN_DOWN","ALL_TROOPS","EXPEDITION_40_PERCENT_CHANCE",v(10,20,30,40,50),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
        ...
        new Row("Alonso","Onslaught","LETHALITY_UP","ALL_TROOPS","EXPEDITION_40_PERCENT_CHANCE",v(10,20,30,40,50),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
        new Row("Alonso","Iron Strength","ENEMY_DAMAGE_DEALT_DOWN","ALL_ENEMY_TROOPS","EXPEDITION_20_PERCENT_CHANCE_ON_ATTACK_FOR_2_TURNS",v(10,20,30,40,50),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
        new Row("Alonso","Poison Harpoon","EXTRA_DAMAGE_DEALT","ALL_TROOPS","EXPEDITION_50_PERCENT_CHANCE_ON_ATTACK",v(10,20,30,40,50),"WhiteoutData / H5Joy; cross-checked 2026-09-09"),
