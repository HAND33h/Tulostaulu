...
public final class VerifiedHeroSkillGen2 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Philly","Expedition Skill 1 Conflict","SOURCE_CONFLICT","ALL_TROOPS","EXPEDITION_DO_NOT_AUTO_SIMULATE",v(3,6,9,12,15),"Older/current public pages disagree on Vigor Tactics vs Miracle Herb; unresolved; do not auto-simulate; audited 2026-09-10"),
