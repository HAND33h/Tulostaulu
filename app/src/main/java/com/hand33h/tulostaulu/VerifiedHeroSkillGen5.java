...
public final class VerifiedHeroSkillGen5 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Hector","Rampant Infantry","DAMAGE_DEALT_UP","INFANTRY","EXPEDITION_FIRST_10_ATTACKS_EACH_NEXT_85_PERCENT_OF_PREVIOUS",v(100,125,150,175,200),"Latest hero-skill update + WhiteoutData + current Whiteout Survival Wiki + Heaven Guardian agree: 10 attacks, each next boost 85% of previous; cross-checked 2026-09-10. Older pages describing five attacks / 80% decay are obsolete."),
        new Row("Hector","Rampant Marksman","DAMAGE_DEALT_UP","MARKSMEN","EXPEDITION_FIRST_10_ATTACKS_EACH_NEXT_85_PERCENT_OF_PREVIOUS",v(20,40,60,80,100),"Latest hero-skill update + WhiteoutData + current Whiteout Survival Wiki + Heaven Guardian agree: 10 attacks, each next boost 85% of previous; cross-checked 2026-09-10. Older pages describing five attacks / 80% decay or Marksman max 50% are obsolete."),
