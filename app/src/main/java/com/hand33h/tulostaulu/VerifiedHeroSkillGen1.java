...
public final class VerifiedHeroSkillGen1 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Jeronimo","Expert Swordsmanship","DAMAGE_DEALT_UP","ALL_TROOPS","EXPEDITION_FOR_2_TURNS_EVERY_4_TURNS",v(6,12,18,24,30),"Current 2026 balance: Whiteout Survival Wiki / WOS Forge / WOS Heroes / Whiteout Battlemaster; old 4/8/12/16/20 stun version is obsolete; cross-checked 2026-09-10"),
        ...
        new Row("Natalia","Feral Protection","DAMAGE_TAKEN_DOWN","ALL_TROOPS","EXPEDITION_40_PERCENT_CHANCE",v(10,20,30,40,50),"Current 2026 balance update replaces old Wildling Roar stun skill; cross-checked against current balance notice 2026-09-10"),
        ...
        new Row("Natalia","Call of the Wild","DAMAGE_DEALT_UP","ALL_TROOPS","EXPEDITION_PASSIVE",v(5,10,15,20,25),"Current WOS Forge Natalia page explicitly says increasing damage dealt for all troops; generic Expedition rules apply in troop combat; previous beast-rallies-only trigger was unsupported; cross-checked 2026-09-10"),
        ...
        new Row("Molly","Snow's Grace","DAMAGE_TAKEN_DOWN","ALL_TROOPS","EXPEDITION_40_PERCENT_CHANCE",v(10,20,30,40,50),"Current 2026 balance: Whiteout Survival Wiki + balance notice; replaces old Calling of the Snow stun version; cross-checked 2026-09-10"),
