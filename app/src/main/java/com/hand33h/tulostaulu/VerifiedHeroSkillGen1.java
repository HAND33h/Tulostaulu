...
public final class VerifiedHeroSkillGen1 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Jeronimo","Expert Swordsmanship","SOURCE_CONFLICT","ALL_TROOPS","EXPEDITION_CONFLICTING_PUBLIC_DESCRIPTIONS",v(6,12,18,24,30),"WOS Battlemaster says Damage Dealt Up for 2 turns every 4 turns; WSCO says 4/8/12/16/20% stun chance for 1 turn. Marked conflict; do not simulate automatically; cross-checked 2026-09-09"),
