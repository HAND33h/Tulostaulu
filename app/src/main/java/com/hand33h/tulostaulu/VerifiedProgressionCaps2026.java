 ...
 * - Legendary T6 Chief Gear (3-Star) unlocks after state progress has Gen 6 heroes.
 * - Chief Charm Lv.17 and Lv.18 unlock once state progress has Gen 8 heroes.
 * - Lv.17 and Lv.18 each contain 9 sub-stages.
 *
 * Naming correction 2026-09-10: current official version history calls the
 * Gen6 ceiling "Legendary T6 Chief Gear (3-Star)". Keep this literal tier name
 * in data so UI/import/export do not silently relabel it as Mythic T6.
 */
