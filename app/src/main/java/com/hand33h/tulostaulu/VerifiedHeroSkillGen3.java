...
public final class VerifiedHeroSkillGen3 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Logan","Power Suit Proc","PROC_CHANCE","LOGAN","EXPLORATION_WHEN_ATTACKED_DEFENSE_BUFF_FOR_2S_UP_TO_5_STACKS",v(8,10,12,14,16),"WhiteoutData / H5Joy / Whiteout Survival Wiki; cross-checked 2026-09-10"),
        new Row("Logan","Power Suit Defense","DEFENSE_UP","LOGAN","EXPLORATION_WHEN_POWER_SUIT_PROCS_FOR_2S_UP_TO_5_STACKS",v(8,11,13,17,20),"H5Joy / Whiteout Survival Wiki / WosGift agree 8/11/13/17/20; WhiteoutData lists 14 at Lv3 and is retained as a documented source conflict; resolved by 3-source majority 2026-09-10"),
        ...
        new Row("Logan","Lion's Might","ATTACK_DOWN","ALL_ENEMY_TROOPS","EXPEDITION_PASSIVE",v(4,8,12,16,20),"Current post-balance version: Whiteout Survival Wiki / WOS Forge / Whiteout Survival Community Wiki / Astris agree; old Lion Strike 20% proc extra-damage version is pre-balance legacy; cross-checked 2026-09-10"),
