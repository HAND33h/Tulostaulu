...
public final class VerifiedHeroSkillGen0 {
    ...
    public static final List<Row> DATA = Collections.unmodifiableList(Arrays.asList(
        ...
        new Row("Seo-yoon","Heartbeat of Valor Attack","ATTACK_UP","ALL_FRIENDLY_HEROES","EXPLORATION_FOR_4S",v(1.5,2,2.5,3,3.5),"Whiteout Survival Wiki / WSCO / whiteout-survival.com; cross-checked 2026-09-10"),
        new Row("Seo-yoon","Heartbeat of Valor Attack Speed","ATTACK_SPEED_UP","ALL_FRIENDLY_HEROES","EXPLORATION_FOR_4S",v(2.5,3,3.5,4,4.5),"Whiteout Survival Wiki / WSCO / whiteout-survival.com; cross-checked 2026-09-10"),
        new Row("Seo-yoon","Bullseye Bash","DAMAGE_DEALT","TARGET","EXPLORATION_ACTIVE",v(150,165,180,195,210),"Whiteout Survival Wiki / WSCO / whiteout-survival.com; cross-checked 2026-09-10"),
        new Row("Seo-yoon","Gale's Pulse","ATTACK_SPEED_UP_PER_STACK","SEO_YOON","EXPLORATION_EVERY_3_BASIC_ATTACKS_LASTS_TO_END",v(1,2,3,4,5),"Whiteout Survival Wiki / WSCO / whiteout-survival.com; cross-checked 2026-09-10"),
        new Row("Seo-yoon","Rallying Beat","ATTACK_UP","ALL_TROOPS","EXPEDITION_PASSIVE",v(5,10,15,20,25),"Whiteout Survival Wiki / WSCO / whiteout-survival.com; cross-checked 2026-09-10"),
        new Row("Seo-yoon","Soothing Dance","HEALING_SPEED_UP","INFIRMARY","EXPEDITION_GROWTH_PASSIVE",v(10,20,30,40,50),"Whiteout Survival Wiki / WSCO / whiteout-survival.com; cross-checked 2026-09-10"),
        new Row("Ling Xue","Hurricane Whirl","DAMAGE_DEALT","AREA_AHEAD","EXPLORATION_ACTIVE",v(300,330,360,390,420),"Whiteout Survival Wiki / WSCO / WOS Heroes / Out of Games; cross-checked 2026-09-10"),
